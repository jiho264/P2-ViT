...
for i in 0 1 2
do
CUDA_VISIBLE_DEVICES=${gpu[$i]} nohup python -u test_quant.py vit_base /home/shared_data/imagenet --quant --ptf --lis --quant-method minmax --mode ${mode[$i]} > logs/vit_base_${mode[$i]}_48 2>&1 &
done
# CUDA_VISIBLE_DEVICES=0 python test_quant.py vit_base /home/shared_data/imagenet --quant --quant-method minmax --mode 2